...
public class PaginatedResult<T> {
	 ...
	 * @param amountPerPage
	 *            the amount the elements per page
	 */
	public PaginatedResult(final int actualPage, final List<T> elements, final long totalElements,
			final long amountPerPage) {
		super();
	...
	/**
	 * Calculate the total amount of pages, using a amount of elements and the
	 * amount of elements per page
	 * 
	 * @param totalElements
	 *            amount of total elements
	 * @param amountPage
	 *            amount of element per page
